...
{
    /// <summary>
    /// This class represents the Collectorate table in the database 
    /// </summary>
	public class Collectorate : Entity
	{
		#region Fields
		...
		public short PortID { get { return _portID; } set { _portID = value;  }}
