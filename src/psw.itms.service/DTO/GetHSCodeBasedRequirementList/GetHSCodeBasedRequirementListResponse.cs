...
{
    public class GetHSCodeBasedRequirementResponse
    {
        [JsonPropertyName("hsCodeBasedRequirementList")]
        public List<GetHSCodeBasedRequirementList> HSCodeBasedRequirementList { get; set; }

        [JsonPropertyName("totalFinancialRequirement")]
        public FinancialRequirement TotalFinancialRequirement { get; set; }

    }
    public class GetHSCodeBasedRequirementList
    {
